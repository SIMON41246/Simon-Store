...
BaseResposne _$BaseResposneFromJson(Map<String, dynamic> json) => BaseResposne()
  ..status = json['status'] as int?
  ..message = json['message'] as String?;

Map<String, dynamic> _$BaseResposneToJson(BaseResposne instance) =>
    <String, dynamic>{
...
CustomerResponse _$CustomerResponseFromJson(Map<String, dynamic> json) =>
    CustomerResponse(
      json['id'] as String?,
      json['name'] as String?,
      json['numofbotifications'] as int?,
    );
...
Map<String, dynamic> _$CustomerResponseToJson(CustomerResponse instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'numofbotifications': instance.numofbotifications,
    };
